...
mod tests {
    ...
    // upstream sync 0.21.0: format_compose_logs

    #[test]
    fn test_format_compose_logs_basic() {
        let raw = "web-1  | 192.168.1.1 - GET / 200\n\
...
api-1  | Connected to database";
    ...
    // upstream sync 0.21.0: format_compose_build

    #[test]
    fn test_format_compose_build_basic() {
        let raw = "[+] Building 12.3s (8/8) FINISHED\n\
